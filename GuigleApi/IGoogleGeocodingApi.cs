...
namespace GuigleApi
{
    public interface IGoogleGeocodingApi
    {
        ...
        Task<Response<Address>> GetAddressFromCoordinatesAsync(HttpClient client, double lat, double lng);
        ...
        Task<Tuple<string, string, string>> GetCityFromCoordinatesAsync(HttpClient client, double lat, double lng);
        ...
        /// <returns>Returns all results from Google Api as an Response<Address>.</returns>
        Task<Response<Address>> SearchAddressAsync(HttpClient client, string address);
        ...
        Task<Tuple<double, double>> GetCoordinatesFromAddressAsync(HttpClient client, string address);
        ...
        /// <returns>Returns all results from Google Api as an Response<Address>.</returns>
        Task<Response<Address>> SearchAddressAsync(HttpClient client, string address, Tuple<double, double> southwest, Tuple<double, double> northeast);
    }
}